(function () {
  ...
  async function run() {
    const button = $('runCode'); button.disabled = true; $('mobileRun').disabled = true; $('labOutput').textContent = 'Python 正在运行...'; $('runtimeText').textContent = '正在加载浏览器 Python 引擎';
    ...
    button.disabled = false; $('mobileRun').disabled = false; markTask('onboardTask3');
  ...
  $('runCode').onclick = run; $('mobileRun').onclick = run;
  ...
  $('runCode').insertAdjacentElement('afterend', shareButton);
