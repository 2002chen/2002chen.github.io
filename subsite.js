(function(){
  ...
  if(!document.querySelector('link[href*="apple-simple.css"]')){const simple=document.createElement('link');simple.rel='stylesheet';simple.href='apple-simple.css?v=1';document.head.appendChild(simple)}
